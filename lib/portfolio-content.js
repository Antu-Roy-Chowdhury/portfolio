...
export async function getContactContent() {
  ...
  return {
    ...
    heading: row?.heading || "Let's talk about collaboration, products, or opportunities.",
    description:
      row?.description ||
      "Right now this contact flow is wired for direct email so you can receive messages simply and reliably while the admin side is still being built.",
  }
}
...
export async function getHomeContent() {
  ...
  return {
    ...
    hero: {
      badge: hero?.badge || "Open for impactful work",
      title: hero?.title || "Building products that feel sharp, useful, and alive.",
